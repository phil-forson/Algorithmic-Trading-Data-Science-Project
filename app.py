...
if currency_pair_option != 'Select from these pairs':
    ...
    counter_output = dict(counter.most_common(10))
    ...
    plt.subplot(2,2,1)
    plt.barh(list(counter_output.keys()), list(counter_output.values()))
    ...
    rates_dataframe = MT5.get_rates(currency_pair_option,5)
